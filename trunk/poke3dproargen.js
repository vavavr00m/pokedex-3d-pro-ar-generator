...
var pokedex = [
	...
	"Metapod","Butterfree","Wedle","Kakuna","Beedrill","Pidgey","Pidgeotto","Pidgeot","Rattata","Raticate","Spearow",
	"Fearow","Ekans","Arbok","Pikachu","Raichu","Sandshrew","Sandslash","Nidoran♀","Nidorina","Nidoqueen","Nidoran♂",
	"Nidorino","Nidoking","Clefairy","Clefable","Vulpix","Ninetales","Jigglypuff","Wigglytff","Zubat","Golbat","Oddish",
	"Gloom","Vileplume","Paras","Parasect","Venonat","Venomoth","Diglett","Dugtrio","Meowth","Persian","Psyduck","Goluck",
	"Mankey","Primeape","Growlithe","Arcanine","Poliwag","Poliwhirl","Poliwrath","Abra","Kadabra","Alakazam","Machop",
	"Machoke","Machamp","Belsprout","Weepinbell","Victreebel","Tentacool","Tentacruel","Geodude","Graveler","Golem",
	"Ponyta","Rapidash","Slowpoke","Slowbro","Magnemite","Mgneton","Farfetch","Doduo","Dodrio","Seel","Dewgong","Grimer",
	"Muk","Shellder","Cloyster","Gastly","Haunter","Gengar","Onix","Drowzee","Hypno","Krabby","Kingler","Voltorb",
	"Electrode","Exeggcute","Exeggutor","Cubone","Marowak","Hitmonlee","Hitmonchan","Lickitung","Koffing","Weezing",
	"Ryhorn","Rhydon","Chansey","Tangela","Kangaskhan","Horsea","Seadra","Goldeen","Seaking","Staryu","Starmie","Mr. Mime",
	"Scyther","Jynx","Electabuzz","Magmar","Pinsir","Tauros","Magikarp","Gyarados","Lapras","Ditto","Eevee","Vaporeon",
	"Jolteon","Flareon","Porygon","Omanyte","Omastar","Kabto","Kabutops","Aerodactyl","Snorlax","Articuno","Zapdos","Moltres",
	"Dratini","Dragonair","Dragonite","Mewtwo","Mew","Chikorita","Bayleef","Megnium","Cyndaquil","Quilava","Typhlosion",
	...
	"Sunflora","Yanma","Wooper","Quagsire","Espeon","mbreon","Murkrow","Slowking","Misdreavus","Unknown","Wobbuffet",
	"Girafarig","Pineco","Forretress","Dunsparce","Gligar","Steelix","Snubbull","Grnbull","Qwilfish","Scizor","Shuckle",
	...
	"Tyrogue","Hitmntop","Smoochum","Elekid","Magby","Miltank","Blissey","Raikou","Entei","Suicune","Larvitar","Pupitar",
	"Tyranitar","Lugia","Ho","Celebi","Treeck","Grovyle","Sceptile","Torchic","Combusken","Blaziken","Mudkip","Marshtomp",
	"Swampert","Poochyena","Mightyena","Zigzagoon","Linoone","Wurmple","Silcoon","Beautifly","Cascoon","Dustox","Lotad",
	"Lombre","Ludicolo","Seedot","Nuzleaf","Shiftry","Taillow","Swellow","Wingull","Pelipper","Rals","Kirlia","Gardevoir",
	"Surskit","Masquerain","Shroomish","Breloom","Slakoth","Vigoroth","Slaking","Nincada","Ninjask","Shedinja","Whismur",
	"Ludred","Exploud","Makuhita","Hariyama","Azurill","Nosepass","Skitty","Delcatty","Sableye","Mawile","Aron","Lairon",
	"Aggron","Meditite","Medicha","Electrike","Manectric","Plusle","Minun","Volbeat","Illumise","Roselia","Gulpin","Swalot",
	"Carvanha","Sharpedo","Wailmer","Wailord","Numel","amerupt","Torkoal","Spoink","Grumpig","Spinda","Trapinch","Vibrava",
	"Flygon","Cacnea","Cacturne","Swablu","Altaria","Zangoose","Seviper","Lunatne","Solrock","Barboach","Whiscash","Corphish",
	"Crawdaunt","Baltoy","Claydol","Lileep","Cradily","Anorith","Armaldo","Feebas","Milotic","Castfom","Kecleon","Shuppet",
	"Banette","Duskull","Dusclops","Tropius","Chimecho","Absol","Wynaut","Snorunt","Glalie","Spheal","Sealeo","Walrein",
	"Claperl","Huntail","Gorebyss","Relicanth","Luvdisc","Bagon","Shelgon","Salamence","Beldum","Metang","Metagross",
	"Regirock","Regice","Registeel","Ltias","Latios","Kyogre","Groudon","Rayquaza","Jirachi","Deoxys (Normal)","Turtwig",
	...
	"Mismagius","Honchkrow","Glameow","Purugly","Chingling","Stunky","Skuntank","Bronzor","Bronzong","Bonsl","Mime Jr.",
	...
	"Magnezone","Lickilicky","Rhyperior","Tangrwth","Electivire","Magmortar","Togekiss","Yanmega","Leafeon","Glaceon",
	"Gliscor","Mamoswine","Porygon","Gallade","Probopass","Dusknoir","Froslas","Rotom","Uxie","Mesprit","Azelf","Dialga",
	...
	"Patrat","Watchog","Lillipup","Herdier","Stoutland","Purrloin","Liepard","Pansage","Simisage","Pansear","Simisar",
	"Panpour","Simipour","Munna","Musharna","Pidove","Tranquill","Unfezant♂","Blitzle","Zebstrika","Roggenrola","Boldore",
	"Gigalith","Woobat","woobat","Drilbur","Excadrill","Audino","Timburr","Gurdurr","Conkeldurr","Tympole","Palpitoad",
	...
	"Dwebble","Crustle","Scraggy","Scrafty","Sigilyph","Yamask","Cofagrigus","Tirtouga","Carracosta","Arhen","Archeops",
	...
	"Chandelure","Axew","Fraxure","Haxorus","Cubchoo","Beartic","Cryogonal","Shelmet","Accelgo","Stunfisk","Mienfoo",
	"Mienshao","Druddigon","Golett","Golurk","Pawniard","Bisharp","Bouffalant","Rufflet","Braviary","Vullaby","Mandibuzz",
	"Hatmor","Durant","Deino","Zweilous","Hydreigon","Larvesta","Volcarona","Cobalion","Terrakion","Virizion",
	...
	"Wormadam (rash cloak)","Shaymin (Sky)","Giratina (Origin)","Rotom (Heat)","Rotom (Wash)","Rotom (Frost)","Rotom (Fan)",
	...
	"Arceus (Grass)","Arceus (Electric)","Arceus (Psychic)","Arceus (Ice)","Arceus (Dragon)","Arceus (Dark)","Unknown (B)",
	"Unknown (C)","Unknown (D)","Unknown (E)","Unknown (F)","Unknown (G)","Unknown (H)","Unknown (I)","Unknown (J)",
	"Unknown (K)","Unknown (L)","Unknown (M)","Unknown (N)","Unknown (O)","Unknown (P)","Unknown (Q)","Unknown (R)",
	"Unknown (S)","Unknown (T)","Unknown (U)","Unknown (V)","Unknown (W)","Unknown (X)","Unknown (Y)","Unknown (Z)",
	"Unknown (!)","Unknown (?)","Basculin (Blue stripe)","Darmanitan (Zen ode)","Deerling (Summer)","Deerling (Autumn)",
	"Deerling (Winter)","Sawsbuck (Summer)","Sawsbuck (Autumn)","Sawsbuck (Winter)","Meloetta (irouette)",
	"Genesect (Shock Drive)","Genesect (Burn Drive)","Genesect (Chill Drive)","Genesect (Douse Drive)","Unfezant♀",
	"Frillish♀","Jellicent♀","Kyurem (White)","Kyurem (Black)","Keldeo (Resolution)","Tornadus (Therian)",
